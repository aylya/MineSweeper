namespace Minesweeper
{
    ...
    class Minesweeper
    {
        ...
        static void Main()
        {
            ...
            if (userInput.Key == ConsoleKey.Y)
            {
                while (bombing)
                {
                    ...
                    ParseUserInput(bombsValue, out bombRow, out bombCol, matrix);
            ...
            while (userInput.KeyChar != 27)
            {
                ...
                ParseUserInput(cellValue, out row, out col, matrix);
        ...
        static void ParseUserInput(string userInput, out int row, out int col, string[,] matrix)
        {
            row = -1;
            col = -1;
